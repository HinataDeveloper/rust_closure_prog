...
// Goal: Using closure: Capturing or moving ownership: Using move keyword
...
fn main() {
    ...
    // Encounter with compile time error. Because list was moved
    // to the closure and it can not be able to borrow again.
